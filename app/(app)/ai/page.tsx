...
import { Send, Bot, User, Paperclip, Trash2, Zap } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-full max-h-[calc(100vh-4rem)] -mx-4 sm:-mx-6 -my-4 sm:-my-6">
      ...
      <div className="flex items-center gap-3 px-6 py-4 border-b border-[rgb(var(--border))] bg-[rgb(var(--card)/0.6)] backdrop-blur-sm flex-shrink-0">
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-[rgb(var(--primary))] to-[rgb(var(--accent))] flex items-center justify-center">
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-4">
        {messages.length === 0 && (
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[rgb(var(--primary))] to-[rgb(var(--accent))] flex items-center justify-center">
              <Bot className="w-8 h-8 text-white" />
            </div>
            <div>
              <h2 className="font-bold text-lg mb-1">Ask me anything</h2>
              <p className="text-sm text-[rgb(var(--muted-fg))] max-w-xs">
                Powered by Claude — I can help with your coursework, exams, and career questions.
              </p>
            </div>
      ...
      <div className="px-4 sm:px-6 py-3 border-t border-[rgb(var(--border))] flex-shrink-0">
        ...
        <p className="text-[10px] text-[rgb(var(--muted-fg))] mt-1.5 px-1 text-center">
          Powered by Claude · 50 messages/day · Enter to send
        </p>
      </div>
    </div>
  );
